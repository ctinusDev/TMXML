...
//  TMXML
//
//  Created by ctinus on 2019/5/12.
//  Copyright © 2019 ctinus. All rights reserved.
//

#import "TMXMLReader.h"
...
@implementation TMXMLReader

#pragma mark - Public methods

+ (NSDictionary *)dictionaryForXMLData:(NSData *)data error:(NSError **)error
{
    TMXMLReader *reader = [[TMXMLReader alloc] initWithError:error];
...
+ (NSDictionary *)dictionaryForXMLString:(NSString *)string error:(NSError **)error
{
    ...
    return [TMXMLReader dictionaryForXMLData:data error:error];
}
...
{
    NSData *data = [string dataUsingEncoding:NSUTF8StringEncoding];
    return [TMXMLReader dictionaryForXMLData:data options:options error:error];
}
